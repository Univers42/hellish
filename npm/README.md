...
from the project's [GitHub Releases](https://github.com/Univers42/42sh/releases).
Currently ships a prebuilt binary for **linux / x64**; on other platforms,
[build from source](https://github.com/Univers42/42sh).
...
- Source & issues: https://github.com/Univers42/42sh
